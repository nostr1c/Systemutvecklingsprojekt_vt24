...
--
drop database if exists ngo_2024; -- drops current database scheme
create database ngo_2024; -- creates a new database scheme with same name
use ngo_2024; -- sets so the code is run on the database scheme ngo_2024

--
-- create dbms user with explicit access to database schema ngo_2024
--
drop user if exists 'dbAdmin2024'@'localhost';
...
INSERT INTO `ans_proj` VALUES (1,1),(1,2),(1,3),(2,6),(2,7),(2,8),(3,11),(3,12),(3,13),(4,16),(3,17),(4,18),(5,21),(5,22),(5,23),(6,26),(6,27),(6,28),(7,31),(7,32),(7,33),(8,36),(8,37),(8,38),(9,41),(9,42),(9,43),(10,46),(10,47),(1,48);
...
INSERT INTO `handlaggare` VALUES (1,'Energi och miljövänliga teknologier\r',NULL),(2,'Hållbart byggande och infrastruktur\r',NULL),(3,'Teknologisk strategi och planering\r',NULL),(4,'Ungdoms- och studentfrågor\r',NULL),(5,'Energi och miljövänliga teknologier\r',1),(8,'Livslångt lärande\r',NULL),(9,'Utveckling av hållbara energikällor\r',NULL),(10,'Kommunikation och samarbete\r',NULL),(12,'Vattenförvaltning och renhållning\r',NULL),(13,'Internationellt samarbete\r',NULL),(14,'Forskning och utvärdering\r',NULL),(15,'Nätverksbyggande och partnerskap\r',NULL),(16,'Nätverksbyggande och partnerskap\r',15),(19,'Entreprenörskapsutbildning och stöd\r',NULL),(20,'Entreprenörskapsutbildning och stöd\r',19),(21,'Internationellt samarbete\r',13),(24,'Teknologisk överföring och kommersialisering\r',NULL),(25,'Hållbar matproduktion och jordbruk\r',2),(26,'Jämställdhet och mångfald\r',NULL),(29,'Hållbar matproduktion och jordbruk\r',25),(30,'Jämställdhet och mångfald\r',26),(31,'Teknologisk överföring och kommersialisering\r',24),(33,'Energianvändningseffektivitet\r',NULL),(34,'Skolutveckling och kvalitetssäkring\r',NULL),(37,'Energianvändningseffektivitet\r',33),(38,'Skolutveckling och kvalitetssäkring\r',34),(39,'Teknologisk forskning och utveckling\r',NULL),(40,'Vattenförvaltning och renhållning\r',12),(43,'Teknologisk forskning och utveckling\r',39),(45,'Energianvändningseffektivitet\r',45),(46,'Utbildningspolitik och planering\r',NULL),(50,'Utbildningspolitik och planering',46);
...
-- Dump completed on 2024-05-07 11:02:30
